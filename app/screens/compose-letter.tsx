...
import { SelectedFriend } from "@/components/letters/SelectedFriend";
  ...
  return (
    <SafeAreaView style={styles.container} edges={["left", "right", "bottom"]}>
      <ScreenHeader
        ...
        rightButtonText={
          <Ionicons name="send" size={scale(20)} color={theme.colors.white} />
        }
          ...
          <View style={styles.friendSelector}>
            {selectedFriend ? (
              ...
              <View style={styles.selectButtonContainer}>
                <Button iconName="add" onPress={handleSelectFriend} />
              </View>
            )}
          </View>
        </View>
      ...
      <ConfirmationModal
        ...
        description={
          selectedFriend
            ? t("confirmation.sendLetter.description", {
