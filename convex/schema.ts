...
const moderationTables = {
  reports: defineTable({
    ...
    targetUserId: v.optional(v.id("users")), // For user reports OR post owner
    targetPostId: v.optional(v.id("posts")), // For post reports only
  })
    .index("by_reporter", ["reporterId"])
    .index("by_targetType", ["targetType"])
    .index("by_targetUser", ["targetUserId"])
    .index("by_targetPost", ["targetPostId"])
    .index("by_reporter_targetType", ["reporterId", "targetType"])
    .index("by_reporter_targetUser", ["reporterId", "targetUserId"])
    .index("by_reporter_targetPost", ["reporterId", "targetPostId"]),
};
